...
optimizer = dict(
    ...
    lr=1e-4, # Tune the base learning rate
)
...
model = dict(
    type='TopDown',
    pretrained='https://download.openmmlab.com/mmpose/animal/hrnet/hrnet_w48_animalpose_256x256-34644726_20210426.pth', 
    backbone=dict(
        type='HRNet',
        in_channels=3,
        extra=dict(
...
data_cfg = dict(
    image_size=[256, 256], # You may also use higher input resolution, e.g. 256x256
    heatmap_size=[64, 64], # heatmap_size should be 1/4 of the image_size
...
train_pipeline = [
    ...
    dict(
        type='TopDownGetRandomScaleRotation', rot_factor=0, scale_factor=0.5), # You may tune these hyper-parameters
